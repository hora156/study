...
public class UserRepositoryTest extends StudyApplicationTests {
    ...
    public void read() {
        ...
        // Lombok 의 chain 패턴을 이용해서 간편하게 update 할 수 있도록 한다.
        /*user.setEmail("")
                .setPhoneNumber("")
                .setStatus("");
        ...
        if(user != null) {
            user.getOrderGroupList().stream().forEach(orderGroup -> {
                ...
                orderGroup.getOrderDetailList().forEach(orderDetail -> {
                    System.out.println("파터너사 이름 : "+orderDetail.getItem().getPartner().getName());
    ...
    @Test
    @Transactional      // 실행시켜도 Rolled back 시켜줌
    public void delete() {
